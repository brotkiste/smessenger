...
public class C_Krypto {
	...
	public static String decryptString(String encrypted, String filenameForPrivateKey, String passwd){
		try {
			return decrypt((InputStream)(new BufferedInputStream(new ByteArrayInputStream(encrypted.getBytes(StandardCharsets.UTF_8)))),(InputStream)(new BufferedInputStream(new FileInputStream(filenameForPrivateKey))), passwd.toCharArray());
	 ...
	 */
	public static PGPPublicKey lookup(String searchphrase){
